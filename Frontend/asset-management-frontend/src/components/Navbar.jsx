  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-3 mt-3 rounded">
      ...
      <ul className="navbar-nav ms-auto">
        <li className="nav-item"><button className="btn btn-link nav-link" onClick={() => navigate('/dashboard')}>Home</button></li>
        ...
        <li className="nav-item"><button className="btn btn-danger nav-link" onClick={() => { logout(); navigate('/'); }}>Logout</button></li>
      </ul>
    </nav>
  );
}
